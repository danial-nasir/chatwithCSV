...
def csv_tool(filename: str):
    return create_csv_agent( 
        ChatOpenAI(temperature=0, model="gpt-4o-2024-08-06"),
        filename,
        verbose=True,
...
def save_json_to_csv(json_response, filename='shortlisted_data.csv'):
...
def ask_agent(agent, query: str, context: str) -> str:
    ...
    -Don't give answers in decimal.
    -Give answer in same font family and size.
    -When user asks to save the response as a csv or pdf do it.
    Query: {query}
    """
